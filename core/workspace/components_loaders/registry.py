...
class ComponentRegistry:
    ...
    def __new__(cls):
        if cls._instance is None:
            ...
            cls._instance._components: Dict[ComponentType, Dict[str, ComponentMetadata]] = {}
    ...
    def register_component(cls, metadata: ComponentMetadata):
        ...
        instance = cls()
        if metadata.component_type not in instance._components:
            instance._components[metadata.component_type] = {}

        # Usamos o nome do arquivo (stem) como chave única
        key = metadata.path.stem
        instance._components[metadata.component_type][key] = metadata
    ...
    def clear(cls):
        ...
        if cls._instance and hasattr(cls._instance, "_components"):
