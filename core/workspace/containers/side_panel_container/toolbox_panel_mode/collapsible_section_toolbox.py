...
class CollapsibleSectionToolbox(QtWidgets.QWidget):
    """
    Componente retrátil (Accordion/Sanfona) especializado para o Modo Toolbox.
...
if __name__ == "__main__":
    ...
    window.setWindowTitle("Teste - CollapsibleSectionToolbox")
    window.resize(300, 200)

    content = QtWidgets.QWidget()
    lay = QtWidgets.QVBoxLayout(content)
    lay.addWidget(QtWidgets.QPushButton("Ferramenta 1"))
    lay.addWidget(QtWidgets.QPushButton("Ferramenta 2"))

    section = CollapsibleSectionToolbox("Toolbox Widget 1", content)
