...
# Tabs
from core.settings.settings_page_tabs.general.tab_appearance_settings import (
    TabAppearance,
)
from core.settings.settings_page_tabs.general.tab_keyboard_settings import (
    TabKeyboard,
)
from core.settings.settings_page_tabs.general.tab_language_settings import (
    TabLanguage,
)
...
from core.settings.settings_page_tabs.workspace.tab_side_panel_settings import (
    TabSidePanel,
)
from core.settings.settings_page_tabs.workspace.tab_toolbar_settings import (
    TabToolbar,
)
