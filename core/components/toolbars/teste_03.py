...
class Teste_03Handler(QtCore.QObject):
    ...
    def load_tools_from_json(self):
        self.toolbar.clear()
        self.toolbar.addWidget(QtWidgets.QLabel("teste_03"))
...
class Component(QtWidgets.QToolBar):
    toolbar_name = "teste_03"

    def __init__(self, modulo=None, scene_manager: Optional["SceneManager"] = None):
        super().__init__()
        self.modulo = modulo
        self.setWindowTitle(self.toolbar_name)
        self.setObjectName("teste_03")
        self.handler = Teste_03Handler(self, scene_manager=scene_manager)
...
if __name__ == "__main__":
    ...
    main_window.setWindowTitle("Debug Toolbar: teste_03")
