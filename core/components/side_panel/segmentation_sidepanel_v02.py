...
class Segmentation_SidePanel(BaseSidePanel):
    ...
    def setup_ui(self) -> None:
        ...
        # GroupBox: Configurações da malha
        ...
        self.combo_qualidade.setCurrentIndex(1)  # Média por padrão
        ...
        # Botão Exportar STL (Correção do CSS: background-color e color no singular)
...
if __name__ == "__main__":
    ...
    from core.components.bases.base_component import AppContext  # <-- Correção aqui
