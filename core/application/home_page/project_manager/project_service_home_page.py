...
class ProjectServiceHomePage:
    ...
    def load_project(self, root_path: Path) -> Optional[Dict[str, Any]]:
        ...
        # Tenta buscar nas subpastas conhecidas para evitar falhas de nomenclatura ("project" vs "project_manager")
    ...
    def list_recent_projects(self) -> List[Dict[str, Any]]:
        ...
        # Varre iterando diretamente pelas pastas de pacientes para garantir rastreabilidade segura
